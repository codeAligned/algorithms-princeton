...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        // test for vertical segment
        a = new Point(5,15);
        b = new Point(5, 25);
        StdOut.println(a.slopeTo(b) == Double.POSITIVE_INFINITY);

        // test for horizontal segment
        a = new Point(7, 10);
        b = new Point(22, 10);
        StdOut.println(a.slopeTo(b) == 0.00);
